...
namespace AE.Net.Mail
{
    ...
    public class MailMessage : ObjectWHeaders
    {
        ...
        {
            using (var str = new System.IO.StreamWriter(stream, encoding ?? Utilities._defaultEncoding, 8096, true))
            {
                Save(str);
            }
        }
        ...
        public virtual void Save(System.IO.TextWriter txt)
        {
            ...
            var otherHeaders = Headers.Where(x => !SpecialHeaders.Contains(x.Key, StringComparer.CurrentCultureIgnoreCase));
